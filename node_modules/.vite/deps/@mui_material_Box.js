...
import { ClassNameGenerator_default, clsx_default, createTheme, identifier_default, require_prop_types, styleFunctionSx_default, styled, useTheme_default } from "./styled-DSC9b8yd.js";
import { extendSxProp } from "./extendSxProp-B1G-EwmH.js";
import { require_jsx_runtime } from "./jsx-runtime-1KWngW6r.js";
import "./styles-DuA3Jiww.js";
...
function createBox(options = {}) {
	const { themeId, defaultTheme: defaultTheme$1, defaultClassName = "MuiBox-root", generateClassName } = options;
	...
	return /* @__PURE__ */ import_react.forwardRef(function Box$1(inProps, ref) {
		const theme = useTheme_default(defaultTheme$1);
...
//#endregion
export { boxClasses_default as boxClasses, Box_default as default };
